<div class="flex items-center space-x-2">
    ...
    {{-- Botón show--}}
    <a
        href="{{ route('semilleros.show', $semillero) }}"
    ...
    @can('semilleros.create')
        {{-- Botón Editar --}}
        <a
            href="{{ route('semilleros.edit', $semillero) }}"
            title="Editar semillero"
            class="bg-amber-100 hover:bg-amber-200 text-amber-700 p-2
        ...
        {{-- Botón Eliminar --}}
        <form
            action="{{ route('semilleros.destroy', $semillero) }}"
            method="POST"
            class="inline"

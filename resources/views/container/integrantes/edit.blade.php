...
@section('content')
    ...
    <div class="max-w-4xl mx-auto">
                ...
                <div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
                    <svg
                        ...
                        <path
                            ...
                            2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828
        ...
        {{-- contenedor tipo card del formulario --}}
                            ...
                            <div class="flex items-center space-x-2">
                                <svg
                                    ...
                                    <path
                                        ...
                                        10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
                                </svg>
        ...
        <div class="flex justify-between items-center mt-8 pt-6 border-t border-border">
            <a
                ...
                class="bg-muted hover:bg-muted/80 text-muted-foreground
